...
const LeaseShowroomMain = () => {
    ...
    try {
      ...
      if (user) {
        ...
        if (response.data.success) {
          toast.success('Commercial showroom lease listing created successfully!');
        }
      } else {
        navigate('/login');
      }
      ...
      toast.error('Failed to create commercial showroom lease listing. Please try again.');
    } finally {
  ...
  return (
    <div ref={formRef} className="min-h-screen bg-white">
      ...
      <div className="mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-black">Lease Commercial Showroom</h1>
        </div>
        <div className="mb-8">
