...
//       const response = await fetch('https://backend-sgxi.onrender.com/api/sign/send-otp', {
//         method: 'POST',
...
//       const response = await fetch('https://backend-sgxi.onrender.com/api/sign/verify-otp', {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
...
//     try {
//       const response = await fetch('https://backend-sgxi.onrender.com/api/sign/register', {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
