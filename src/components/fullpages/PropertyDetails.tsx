    ...
    const fetchPropertyDetails = async () => {
      try {
        ...
        const propertyResponse = await fetch(
          `https://api.rentamigo.inhttps://backend-sgxi.onrender.com/api/properties/propertyds/${propertyId}`
        );
        ...
        const availabilityResponse = await fetch(
          `https://api.rentamigo.inhttps://backend-sgxi.onrender.com/api/properties/${propertyId}/availability`
        );
        ...
        const restrictionsResponse = await fetch(
          `https://api.rentamigo.inhttps://backend-sgxi.onrender.com/api/properties/${propertyId}/restrictions`
        );
